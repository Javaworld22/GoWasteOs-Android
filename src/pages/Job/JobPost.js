...
export default class JobPost extends Component {
    ...
    _jobPost = async () => {
        ...
        formData.append("noti_date_time",moment(new Date()).format('YYYY-MM-DD HH:mm:ss'));
        
        // console.log("Response ", formData);
    
        this.setState({ showLoader: true });
        let response = await POST(endPoints.jobpost, formData, {
          Authorization: await Retrieve("userToken")
        });
        this.setState({ showLoader: false });
        ...
        if (response.details.ack == 1) {
            ...
            Alert.alert("", "Job posted successfully.", [
                { text: "Ok", onPress: () => this.props.navigation.navigate('JobList')}
            ]);
        } else {
                            ...
                            <View style={style.mT2}>
                                ...
                                <View style={[style.mT4,style.pB5]}>
                                    <TouchableOpacity style={style.themebtn} onPress={() => this._jobPost()}>
                                        <Text style={style.btntext}>Post Job</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>
