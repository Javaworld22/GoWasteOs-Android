...
import { Text, View, SafeAreaView, TouchableOpacity, StatusBar,TextInput, Image, ScrollView } from 'react-native'
            ...
            <SafeAreaView style={style.wrapper}>
                ...
                <Modal isVisible={this.state.isModalVisible}>
                    <View style={style.modalcenter}>
                        <TouchableOpacity style={style.closemodal}>
                            <Icon name="close-circle" color="#f00" size={30}  />
                        </TouchableOpacity>
                        <Text style={style.mheading}>Rating Us</Text>
                        <View style={[style.rowCenter, style.alignCenter ]}>
                            <Icon name="md-star" color="#fff" size={20} style={style.mR1} />
                            <Icon name="md-star" color="#fff" size={20} style={style.mR1} />
                            <Icon name="md-star" color="#fff" size={20} style={style.mR1} />
                            <Icon name="md-star-half" color="#fff" size={20} style={style.mR1} />
                            <Icon name="md-star-outline" color="#fff" size={20} style={style.mR1} />
                        </View>
                ...
                <View style={style.hnavigation}>
                        <TouchableOpacity style={style.iconback} onPress={() => this.props.navigation.goBack()}>
                            <Ionicons name="md-arrow-back" color="#fb6400" size={30} />
                        </TouchableOpacity>
                        ...
                        <View style={style.container}>
                            ...
                            <View style={[style.frmbetween, style.mT2]}>
                                ...
                                <View style={styles.dtwrap}>
                                    ...
                                    <Ionicons name="md-calendar" color="#fb6400" size={22} />
                                </View>
                            </View>
                                            ...
                                            <View style={styles.rowbetween}>
                                                <View style={styles.rwrap}>
                                                     ...
                                                     <View style={style.rowSec}>
                                                        <Ionicons name="md-star" color="#fbc201" size={20} />
